...
class Employee :
    def __init__(self,root) :
        ...
        lbl_title = Label(self.root,text="EMPLOYEE MANAGEMENT SYSTEM",
                          font=('times new roman',37,'bold'),fg='#03045E',bg='#a3b18a')
        lbl_title.place(x=0,y=0,width=1365,height=50)
        
        # logo
        img_logo = Image.open('images/myLogo.jpeg')
        ...
        #image frame
        img_frame = Frame(self.root,bd=2,relief='ridge',bg='#a3b18a')
        img_frame.place(x=0,y=50,width=1360,height=160)

        # 1st image
        img1 = Image.open('images/banner3.png')
        img1 = img1.resize((1360,160))
        self.photo1 = ImageTk.PhotoImage(img1)

        self.img_1 = Label(img_frame,image=self.photo1)
        self.img_1.place(x=0,y=0,width=1360,height=160)
        ...
        # main frame
        Main_frame=Frame(self.root,bd=2,relief='ridge',bg='#a3b18a')
        Main_frame.place(x=0,y=200,width=1365,height=560)

        # upper frame
        upper_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='white',
                                 text='Employee Management Information',
                                 font=('arial',11,'bold'),fg='#03045E')
        upper_frame.place(x=10,y=10,width=1340,height=220)

        #label for combo field for dep
        lbl_dep = Label(upper_frame,text="Department",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_name = Label(upper_frame,text="Name",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_phone = Label(upper_frame,text="Phone",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_email = Label(upper_frame,text="Email",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_address = Label(upper_frame,text="Address",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_country = Label(upper_frame,text="Country",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_DOB = Label(upper_frame,text="DOB",font=('arial',11,'bold'),bg='white', fg='#03045E')
        lbl_DOB.grid(row=2,column=0,padx=2,pady=7,sticky=W)

        entry_DOB = DateEntry(upper_frame,textvariable=self.dob,font=('arial',11,'bold'),width=20, date_pattern="dd-mm-yyyy",selectmode='day', day=1, month=6, year=1999)
        entry_DOB.grid(row=2,column=1,padx=2,pady=7,sticky=W)

         #label for entry field for DOJ
        lbl_DOJ = Label(upper_frame,text="DOJ",font=('arial',11,'bold'),bg='white', fg='#03045E')
        lbl_DOJ.grid(row=2,column=2,padx=2,pady=7,sticky=W)

        entry_DOJ= DateEntry(upper_frame,textvariable=self.doj,font=('arial',11,'bold'),width=20, date_pattern="dd-mm-yyyy",selectmode='day', day=1, month=6, year=2020)
        entry_DOJ.grid(row=2,column=3,padx=2,pady=7,sticky=W)

         #label for entry field for Salary (CTC)
        lbl_CTC = Label(upper_frame,text="CTC",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_Married_status = Label(upper_frame,text="Married Status",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_gender = Label(upper_frame,text="Gender",font=('arial',11,'bold'),bg='white', fg='#03045E')
        ...
        lbl_combo['value'] =("Male","Female", "Prefer Not To Say")
        lbl_combo.current(0)
        ...
        #Add Employee Image
        employeeImg= Image.open('images/myLogo.jpeg')
        ...
        button_frame = Frame(upper_frame,bd=2,relief='ridge',bg='#a3b18a')
        button_frame.place(x=1185,y=4,width=125,height=190)

        btn_save = Button(button_frame,text="Save",command=self.AddData,font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_save.grid(row=0,column=0,pady=7,sticky=W)

        btn_update = Button(button_frame,command=self.updateData,text="Update",font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_update.grid(row=1,column=0,pady=7,sticky=W)

        btn_delete = Button(button_frame,text="Delete",command=self.deleteData,font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_delete.grid(row=2,column=0,pady=7,sticky=W)

        btn_reset = Button(button_frame,text="Reset",command=self.resetEmployeeInfo,font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_reset.grid(row=3,column=0,pady=7,sticky=W)

        # down frame
        down_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='#a3b18a',
                                 text='Employee Management Information Table',
                                 font=('arial',11,'bold'),fg='#03045E')
        down_frame.place(x=10,y=230,width=1340,height=240)

        #searh Frame
        search_frame= LabelFrame(down_frame,text="Search Employee Information",relief='ridge',bd=2,font=('arial',11,'bold'),fg='#03045E', bg='#a3b18a')
        search_frame.place(x=0,y=0,width=1320,height=55)
        ...
        btn_search = Button(search_frame,command=self.searchEmployeeInfo,text="Search",font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_search.grid(row=0,column=3,padx=4,pady=2,sticky=W)

        btn_showAll = Button(search_frame,text="Show All",command=self.ShowAll,font=('arial',12,'bold'),fg='white',bg='#344e41',width=12)
        btn_showAll.grid(row=0,column=4,padx=4,pady=2,sticky=W)

        #searh Frame
        table_frame= Frame(down_frame,relief='ridge',bd=2,bg='#a3b18a')
        table_frame.place(x=0,y=55,width=1320,height=180)
...
if __name__ == "__main__" :
    root = Tk()
    img = PhotoImage(file='images/icimg.png')
